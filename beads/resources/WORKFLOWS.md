...
- [Integration with update_plan](#integration-with-update_plan) - Using both tools together
...
- [ ] Reconstruct update_plan list from notes if needed
```
...
- [ ] Create update_plan from acceptance criteria for execution
- [ ] Work through update_plan items
- [ ] Update bd design notes as you learn
- [ ] When update_plan complete, close bd issue
```

**Why hybrid**: bd provides persistent structure, update_plan provides visible progress.
...
**Should I create a bd issue or use update_plan?**
...
1. Transition from update_plan to bd mid-session
