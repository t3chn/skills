...
from core.transcript_analyzer import analyze_transcript, read_transcript  # noqa: E402
...
def main():
    ...
    try:
        ...
        # We consume stdin but don't use the data - transcript is read from file
        try:
            _input_data = json.load(sys.stdin)  # noqa: F841
...
"""
        ...
        error_output = {"systemMessage": f"TDD Enforcer error: {str(e)}"}
